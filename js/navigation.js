...
(function() {
    ...
    function initNavigation() {
        ...
        function handleNavbarScroll() {
            // Don't change navbar state if mobile menu is open
        ...
        function updateActiveLink() {
            // Don't update active links if mobile menu is open
            if (navbarCollapse && navbarCollapse.classList.contains('show')) {
                return;
            }
            ...
            sections.forEach(section => {
                ...
                if (scrollPosition >= sectionTop && scrollPosition < sectionTop + sectionHeight) {
                    // Remove active class from all NON-DROPDOWN links only
                    navLinks.forEach(link => {
                    ...
                    if (activeLink && !activeLink.classList.contains('btn') && !activeLink.classList.contains('dropdown-toggle')) {
